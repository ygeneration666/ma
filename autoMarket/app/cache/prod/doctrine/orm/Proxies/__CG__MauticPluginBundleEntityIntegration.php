...
class Integration extends \Mautic\PluginBundle\Entity\Integration implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Mautic\\PluginBundle\\Entity\\Integration' . "\0" . 'id', '' . "\0" . 'Mautic\\PluginBundle\\Entity\\Integration' . "\0" . 'plugin', '' . "\0" . 'Mautic\\PluginBundle\\Entity\\Integration' . "\0" . 'name', '' . "\0" . 'Mautic\\PluginBundle\\Entity\\Integration' . "\0" . 'isPublished', '' . "\0" . 'Mautic\\PluginBundle\\Entity\\Integration' . "\0" . 'supportedFeatures', '' . "\0" . 'Mautic\\PluginBundle\\Entity\\Integration' . "\0" . 'apiKeys', '' . "\0" . 'Mautic\\PluginBundle\\Entity\\Integration' . "\0" . 'featureSettings');
        }
