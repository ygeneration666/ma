...
class LeadEventLog extends \Mautic\CampaignBundle\Entity\LeadEventLog implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Mautic\\CampaignBundle\\Entity\\LeadEventLog' . "\0" . 'event', '' . "\0" . 'Mautic\\CampaignBundle\\Entity\\LeadEventLog' . "\0" . 'lead', '' . "\0" . 'Mautic\\CampaignBundle\\Entity\\LeadEventLog' . "\0" . 'campaign', '' . "\0" . 'Mautic\\CampaignBundle\\Entity\\LeadEventLog' . "\0" . 'ipAddress', '' . "\0" . 'Mautic\\CampaignBundle\\Entity\\LeadEventLog' . "\0" . 'dateTriggered', '' . "\0" . 'Mautic\\CampaignBundle\\Entity\\LeadEventLog' . "\0" . 'isScheduled', '' . "\0" . 'Mautic\\CampaignBundle\\Entity\\LeadEventLog' . "\0" . 'triggerDate', '' . "\0" . 'Mautic\\CampaignBundle\\Entity\\LeadEventLog' . "\0" . 'systemTriggered', '' . "\0" . 'Mautic\\CampaignBundle\\Entity\\LeadEventLog' . "\0" . 'metadata', '' . "\0" . 'Mautic\\CampaignBundle\\Entity\\LeadEventLog' . "\0" . 'nonActionPathTaken');
        }
