...
class Lead extends \Mautic\CampaignBundle\Entity\Lead implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Mautic\\CampaignBundle\\Entity\\Lead' . "\0" . 'campaign', '' . "\0" . 'Mautic\\CampaignBundle\\Entity\\Lead' . "\0" . 'lead', '' . "\0" . 'Mautic\\CampaignBundle\\Entity\\Lead' . "\0" . 'dateAdded', '' . "\0" . 'Mautic\\CampaignBundle\\Entity\\Lead' . "\0" . 'manuallyRemoved', '' . "\0" . 'Mautic\\CampaignBundle\\Entity\\Lead' . "\0" . 'manuallyAdded');
        }
