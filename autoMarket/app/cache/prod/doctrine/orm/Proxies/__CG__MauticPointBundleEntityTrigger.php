...
class Trigger extends \Mautic\PointBundle\Entity\Trigger implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Mautic\\PointBundle\\Entity\\Trigger' . "\0" . 'id', '' . "\0" . 'Mautic\\PointBundle\\Entity\\Trigger' . "\0" . 'name', '' . "\0" . 'Mautic\\PointBundle\\Entity\\Trigger' . "\0" . 'description', '' . "\0" . 'Mautic\\PointBundle\\Entity\\Trigger' . "\0" . 'publishUp', '' . "\0" . 'Mautic\\PointBundle\\Entity\\Trigger' . "\0" . 'publishDown', '' . "\0" . 'Mautic\\PointBundle\\Entity\\Trigger' . "\0" . 'points', '' . "\0" . 'Mautic\\PointBundle\\Entity\\Trigger' . "\0" . 'color', '' . "\0" . 'Mautic\\PointBundle\\Entity\\Trigger' . "\0" . 'triggerExistingLeads', '' . "\0" . 'Mautic\\PointBundle\\Entity\\Trigger' . "\0" . 'category', '' . "\0" . 'Mautic\\PointBundle\\Entity\\Trigger' . "\0" . 'events', 'changes');
        }
