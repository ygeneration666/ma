...
class Role extends \Mautic\UserBundle\Entity\Role implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Mautic\\UserBundle\\Entity\\Role' . "\0" . 'id', '' . "\0" . 'Mautic\\UserBundle\\Entity\\Role' . "\0" . 'name', '' . "\0" . 'Mautic\\UserBundle\\Entity\\Role' . "\0" . 'description', '' . "\0" . 'Mautic\\UserBundle\\Entity\\Role' . "\0" . 'isAdmin', '' . "\0" . 'Mautic\\UserBundle\\Entity\\Role' . "\0" . 'permissions', '' . "\0" . 'Mautic\\UserBundle\\Entity\\Role' . "\0" . 'rawPermissions', '' . "\0" . 'Mautic\\UserBundle\\Entity\\Role' . "\0" . 'users', 'changes');
        }
