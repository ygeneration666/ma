...
class Log extends \Mautic\WebhookBundle\Entity\Log implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Mautic\\WebhookBundle\\Entity\\Log' . "\0" . 'id', '' . "\0" . 'Mautic\\WebhookBundle\\Entity\\Log' . "\0" . 'webhook', '' . "\0" . 'Mautic\\WebhookBundle\\Entity\\Log' . "\0" . 'statusCode', '' . "\0" . 'Mautic\\WebhookBundle\\Entity\\Log' . "\0" . 'dateAdded');
        }
