...
class Category extends \Mautic\CategoryBundle\Entity\Category implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Mautic\\CategoryBundle\\Entity\\Category' . "\0" . 'id', '' . "\0" . 'Mautic\\CategoryBundle\\Entity\\Category' . "\0" . 'title', '' . "\0" . 'Mautic\\CategoryBundle\\Entity\\Category' . "\0" . 'description', '' . "\0" . 'Mautic\\CategoryBundle\\Entity\\Category' . "\0" . 'alias', '' . "\0" . 'Mautic\\CategoryBundle\\Entity\\Category' . "\0" . 'color', '' . "\0" . 'Mautic\\CategoryBundle\\Entity\\Category' . "\0" . 'bundle', 'changes');
        }
